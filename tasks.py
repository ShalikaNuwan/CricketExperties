...
from agents import cricket_researcher, cricket_analyst, pro_gambler
...
gather_historical_data = Task(
    ...
    context=[gather_match_data], #add the dependancies
    agent=cricket_researcher
)
...
analyse_match_data = Task(
    description=(
        "Analyze the data gathered on the cricket match, including the team."
...
statistical_analysis = Task(
    description=(
        ...
        "Calculating averages, percentages, and other relevant statistics"
    ),
    expected_output=(
